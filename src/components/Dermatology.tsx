  ...
  return (
    ...
    <div className="flex w-full justify-center overflow-hidden bg-white">
      <div className="relative h-[2858px] w-[1920px] shrink-0 overflow-hidden bg-white pt-[188px]">
        ...
        <p className="absolute left-[1295px] top-[494px] font-['Google_Sans:Medium',sans-serif] text-[60px] leading-[66px] text-[#051c2f] hero-clip-wrap"><span className="hero-clip-line d2">Dermatology</span></p>
        ...
        <button type="button" onClick={onNavigateProducts} className="absolute left-[195px] top-[1060px] h-[320px] w-[450px] bg-white text-left">
          <div className="absolute left-[46px] top-[51px] h-[70px] w-[70px] overflow-hidden"><img alt="" className="size-full object-contain" src={iconDerm} /></div>
          <div className="absolute left-[395px] top-[39px] h-[20px] w-[20px]"><img alt="" className="size-full -scale-x-100" src={backArrow} /></div>
          <p className="absolute left-[46px] top-[141px] w-[359px] font-['Google_Sans:Medium',sans-serif] text-[36px] leading-[37px] text-[#9d0b0f]">Dermatology</p>
          <p className="absolute left-[46px] top-[192px] w-[321px] font-['Google_Sans:Regular',sans-serif] text-[17px] leading-[28px] text-[#0b0f13]/70">Topical treatments for skin infections and inflammation including Terbinafine<br />and Tretinoin.</p>
        </button>
        ...
        <div className="fixed inset-x-0 top-0 z-[70] flex justify-center">
          <div className="relative h-[188px] w-[1920px]">
            <div className="absolute left-[2px] top-0 h-[188px] w-[1919px] bg-[#f5f8f9]" />
