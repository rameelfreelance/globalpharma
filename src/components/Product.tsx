      ...
      <div className="product-figma relative h-[3071px] w-[1920px] shrink-0 overflow-hidden bg-white pt-[188px]">
        ...
        <div className="fixed inset-x-0 top-0 z-[70] flex justify-center">
          <div className="relative h-[188px] w-[1920px]">
            ...
            <div className="absolute left-[727px] top-[71px] z-20 h-[229px] w-[180px]" onMouseEnter={() => setShowCompanyMenu(true)} onMouseLeave={() => setShowCompanyMenu(false)}>
            ...
            <div className="absolute left-[925px] top-[72px] z-20 h-[440px] w-[175px]" onMouseEnter={() => setShowProductsMenu(true)} onMouseLeave={() => setShowProductsMenu(false)}>
